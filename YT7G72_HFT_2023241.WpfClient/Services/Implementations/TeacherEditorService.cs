...
{
    public class TeacherEditorService : ITeacherEditor
    {
        public void Edit(Teacher teacher)
        {
            var vm = new TeacherEditWindowViewModel(teacher, Ioc.Default.GetService<IMessageBoxService>());
            new TeacherEditWindow(vm).Show();
        }
    }
}
