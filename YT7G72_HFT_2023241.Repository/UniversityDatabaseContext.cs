        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Subject>().HasData(
                    new object[] {
                        ...
                        new { Id = 2, SubjectName = "Software Design and Development II", SubjectCode = "NIKCESZTF2", Credits = 6,  CurriculumId = 1, TeacherId = 6, Requirement = Requirement.WRITTEN_AND_SPOKEN_EXAM}
            ...
            builder.Entity<Course>().HasData(
                    new object[]
                    {
                        ...
                        new { Id = 10, CourseName = "Sztf2 Lab01", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeSpan(8, 0, 0), LengthInMinutes = 150, TeacherId = 7, SubjectId = 2, Room = "BA.1.13"},
                        new { Id = 11, CourseName = "Sztf2 Lab02", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeSpan(12, 35, 0), LengthInMinutes = 150, TeacherId = 8, SubjectId = 2, Room = "BA.1.15"},
                        new { Id = 12, CourseName = "Sztf2 Lab03", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeSpan(14, 25, 0), LengthInMinutes = 150, TeacherId = 9, SubjectId = 2, Room = "BA.1.14"},
                        new { Id = 13, CourseName = "Sztf2 Lab04", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeSpan(15, 20, 0), LengthInMinutes = 150, TeacherId = 8, SubjectId = 2, Room = "BA.1.15"},
                        new { Id = 14, CourseName = "Sztf2 Lab05", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Tuesday, StartTime = new TimeSpan(14, 25, 0), LengthInMinutes = 150, TeacherId = 9, SubjectId = 2, Room = "BA.1.13"},
                        new { Id = 15, CourseName = "Sztf2 Lab06", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Tuesday, StartTime = new TimeSpan(17, 05, 0), LengthInMinutes = 150, TeacherId = 9, SubjectId = 2, Room = "BA.1.13"},
                        new { Id = 16, CourseName = "Sztf2 Lab07", CourseCapacity = 15, CourseType = CourseType.LECTURE, DayOfWeek = DayOfWeek.Monday, StartTime = new TimeSpan(8, 0, 0), LengthInMinutes = 150, TeacherId = 7, SubjectId = 2, Room = "BA.1.13"},
                    }
                );
